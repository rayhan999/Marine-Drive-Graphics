...
{
    glPushMatrix();
    glTranslatef(position5+0.4f,-0.01f, 0.0f);
    //car
    glPushMatrix();
    ...
    glColor3ub(44, 50, 135);
    glVertex2f(0.02f, -0.00650f);
    glVertex2f(0.01f, -0.045f);
    glVertex2f(.065f, -0.045f);
    glVertex2f(.055f, -0.0065f);

    glEnd();

    glBegin(GL_POLYGON);// upper light

    glColor3ub(k, o, 10);
    glVertex2f(0.055f, -0.00650f);
    glVertex2f(0.065f, -0.025f);
    glVertex2f(.045f, -0.025f);
    glVertex2f(.045f, -0.0065f);
...
{
    glPushMatrix();
    glTranslatef(position5+1.2f,-0.01f, 0.0f);
    //car
    glPushMatrix();
    glBegin(GL_POLYGON);// lower

    glColor3ub(6, 224, 195);
    glVertex2f(0.0f, -0.025f);
    glVertex2f(0.0f, -0.045f);
    glVertex2f(.085f, -0.045f);
    glVertex2f(.085f, -0.025f);
...
{
    glPushMatrix();
    glTranslatef(position5-0.3f,-0.01f, 0.0f);
    //car
    glPushMatrix();
    glBegin(GL_POLYGON);// lower

    glColor3ub(184, 6, 224);
    glVertex2f(0.0f, -0.025f);
    glVertex2f(0.0f, -0.045f);
    glVertex2f(.085f, -0.045f);
    glVertex2f(.085f, -0.025f);
...
{
    glPushMatrix();
    glTranslatef(position6+0.9f,-0.08f, 0.0f);
    //car
    glPushMatrix();
    glBegin(GL_POLYGON);// white
...
{
    glPushMatrix();
    glTranslatef(position6-0.4f,-0.08f, 0.0f);
    //car
    glPushMatrix();
    glBegin(GL_POLYGON);// white

    glColor3ub(48, 160, 64);
    glVertex2f(0.0f, -0.025f);
    glVertex2f(0.0f, -0.045f);
    glVertex2f(.085f, -0.045f);
    glVertex2f(.085f, -0.025f);
